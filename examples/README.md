...
| [`scope-challenge/`](./scope-challenge/README.md)                   | SEP-2350 step-up against a real AS: per-tool `scopeChallenge` callbacks, `403` + `WWW-Authenticate` before dispatch                                         | http         | modern         |
